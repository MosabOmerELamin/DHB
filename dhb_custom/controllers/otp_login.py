...
class OtpLoginHome(Home):
    ...
    def web_login(self, redirect=None, **kw):
        ...
        if request.httprequest.method == 'GET':
            ...
            if "otp_login" and "otp" in kw:
                if kw["otp_login"] and kw["otp"]:
                    return request.render("dhb_custom.custom_login_template", {'otp': True, 'otp_login': True})
            if "otp_login" in kw:  # checks if the keyword "otp_login" exists in the dict "kw".
                # checks if the value of "otp_login" is true.
                if kw["otp_login"]:
                    return request.render("dhb_custom.custom_login_template", {'otp_login': True})
            else:
        ...
        return request.render("dhb_custom.custom_login_template", {})
    ...
    def web_otp_login(self, **kw):
        ...
        if user_id:
            ...
            mail.send()
            response = request.render("dhb_custom.custom_login_template", {'otp': True, 'otp_login': True,
            ...
            response = request.render("dhb_custom.custom_login_template", {'otp': False, 'otp_login': True,
                                                                           'login_error': True})
            return response
    ...
    def web_otp_verify(self, *args, **kw):
        ...
        res_id = request.env['otp.verification'].search(
